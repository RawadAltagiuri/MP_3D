    ...
    methods
        ...
        function retract(obj, retAmount)
            ...
            while retAmount > 0 && lastExpanded > 0
                if obj.j_space(lastExpanded, 3) > retAmount
                    obj.j_space(lastExpanded, 3) = obj.j_space(lastExpanded, 3) - retAmount;
                    break;
                else
                    retAmount = retAmount - obj.j_space(lastExpanded, 3);
                    obj.j_space(lastExpanded, :) = 0;
                    lastExpanded = lastExpanded - 1;
                end
            end
        end
